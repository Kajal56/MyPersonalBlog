...
export default function ContactPage() {
  ...
  <div className="min-h-screen flex flex-col items-center justify-center bg-transparent py-10 px-4">
      ...
      <div className="flex justify-center gap-6 mb-8">
        ...
        <a href="https://www.instagram.com/kajal_._malik" target="_blank" rel="noopener" aria-label="Instagram">
        ...
        <a href="https://www.facebook.com/kajal.malik.7712826/" target="_blank" rel="noopener" aria-label="Facebook">
        ...
        <a href="https://www.linkedin.com/in/kajalmalikk/" target="_blank" rel="noopener" aria-label="LinkedIn">
      ...
      {isAdminMode && (
        <div className="mt-10">
          <h2 className="text-2xl font-bold mb-4 text-white">Contact Messages</h2>
          {loadingMessages ? (
            ...
            <div className="space-y-4">
              {messages.map(msg => (
                <div key={msg.id} className="bg-transparent p-4 rounded-lg shadow">
                  <div className="font-semibold text-white">{msg.name || 'Anonymous'}</div>
                  <div className="text-white text-sm">{msg.message}</div>
                  <div className="text-xs text-white mt-1">{msg.email || 'No email'} | {new Date(msg.dateSent).toLocaleString()}</div>
                </div>
              ))}
            </div>
          )}
