...
export default function PersonalPage() {
  ...
  <div className="max-w-3xl mx-auto bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg shadow-lg p-8 border border-blue-100 dark:border-gray-800">
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {recentEntries.map((entry, index) => (
                <div key={index} className="border-l-4 border-blue-500 pl-4 bg-white/80 dark:bg-gray-800 py-2 flex flex-col gap-1">
                  <div className="flex items-center justify-between">
                    <h3 className="font-semibold text-gray-900 dark:text-gray-100">{entry.title}</h3>
                    <span className="text-xs text-blue-500 dark:text-blue-300 capitalize px-2 py-1 bg-blue-100/60 dark:bg-blue-900/60">{entry.type}</span>
                  </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          <Link href="/personal/movies" className="backdrop-blur-lg bg-white/80 dark:bg-gray-800/80 shadow-lg p-8 border border-blue-100 dark:border-gray-800 hover:bg-blue-100/80 dark:hover:bg-gray-800/80 transition-all">
          ...
          <Link href="/personal/books" className="backdrop-blur-lg bg-white/80 dark:bg-gray-800/80 shadow-lg p-8 border border-blue-100 dark:border-gray-800 hover:bg-blue-100/80 dark:hover:bg-gray-800/80 transition-all">
            <div className="text-center">
              <div className="text-3xl mb-3">📚</div>
          ...
          <Link href="/personal/trips" className="backdrop-blur-lg bg-white/80 dark:bg-gray-800/80 shadow-lg p-8 border border-blue-100 dark:border-gray-800 hover:bg-blue-100/80 dark:hover:bg-gray-800/80 transition-all">
            <div className="text-center">
          ...
          <Link href="/personal/restaurants" className="backdrop-blur-lg bg-white/80 dark:bg-gray-800/80 shadow-lg p-8 border border-blue-100 dark:border-gray-800 hover:bg-blue-100/80 dark:hover:bg-gray-800/80 transition-all">
            <div className="text-center">
              <div className="text-3xl mb-3">🍽️</div>
          ...
          <Link href="/personal/flats" className="backdrop-blur-lg bg-white/80 dark:bg-gray-800/80 shadow-lg p-8 border border-blue-100 dark:border-gray-800 hover:bg-blue-100/80 dark:hover:bg-gray-800/80 transition-all">
            <div className="text-center">
              <div className="text-3xl mb-3">🏠</div>
          ...
          <Link href="/personal/feed" className="backdrop-blur-lg bg-white/80 dark:bg-gray-800/80 shadow-lg p-8 border border-blue-100 dark:border-gray-800 hover:bg-blue-100/80 dark:hover:bg-gray-800/80 transition-all">
            <div className="text-center">
              <div className="text-3xl mb-3">📝</div>
