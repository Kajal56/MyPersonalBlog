...
export default function Navigation() {
  ...
  return (
  <nav className="bg-white bg-transparent shadow-lg transition-colors duration-300">
            ...
            {navItems.map((item) => (
              <Link
                ...
                className={`px-3 py-2 text-sm font-medium transition-colors ${
                  pathname === item.href
                    ? 'bg-blue-100 bg-transparent text-blue-700 dark:text-blue-300'
                    : 'text-white dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400'
                }`}
              >
                {item.label}
              </Link>
